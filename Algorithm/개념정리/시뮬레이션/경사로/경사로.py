    ...
    while column_flag < size-1:
        ...
        if a == road_matrix[row][column_flag+1]:
            ...
            for i in range(length):
                if road_matrix[row][column_flag - i] != a or visited[column_flag - i] or column_flag-(length-1) < 0:
                    flag = 0
                    break
            if flag:
                a = a + 1
    ...
    while row_flag < size-1:
        ...
        if a == road_matrix[row_flag+1][column]:
            ...
            for j in range(length):
                if road_matrix[row_flag-j][column] != a or visited[row_flag - j] or row_flag-(length-1) < 0:
                    flag = 0
                    break
            if flag:
                a = a + 1
