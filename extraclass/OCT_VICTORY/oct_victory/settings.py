...
SECRET_KEY = '4bjl)0v0l&xk=$b$$n#9c((-+hfkz^eh+_lm7xa(i56ab)y*e&'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            # 추가적으로 여기(PROJECT/templates)도 찾아 주세요..
...
TIME_ZONE = 'Asia/Seoul'  # 저장되는 DateTimeField 의 값이 바뀌는게 아니라 표시되는 시간이 바뀜
# 국제화 대응 I nternationalizatio N
USE_I18N = True
# 현지화 대응 L ocalizatio N
USE_L10N = True
# 이걸 False 로 바꾸면, 저장도 Asia/Seoul로 바뀜
USE_TZ = True
...
STATICFILES_DIRS = [
    ...
    # 추가적으로 여기(PROJECT/assets)도 찾아 주세요..
